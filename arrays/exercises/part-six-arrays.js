...
//'table' with one index vs. two indices (table[][]).
console.log(table [1])
...
// contains the element arrays, and the second level holds the name/symbol/mass values. 
//Experiment! Create a 3-dimensional array and print out one entry from each level in the array.
let pokemon = ['Ash', 'Pikachu', 'cap'];
let pokemon2 = ['Brock', 'Vulpix', 'pan'];
let pokemon3 = ['Misty', 'psyduck', 'bike'];
const poketable = []

poketable.push(pokemon)
poketable.push(pokemon2)
poketable.push(pokemon3)
console.log(poketable)
console.log(poketable[0][1])
console.log(poketable[1][1])
console.log(poketable[2][0])
